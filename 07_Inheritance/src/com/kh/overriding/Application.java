...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(customer2); // 같은 이름이어도 주소값이 다름
		
		System.out.println(customer1.equals(customer2)); // false // equals 재정의 후는 true로 바뀜
