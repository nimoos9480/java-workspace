 ...
 * 
 * 상속의 특징
 * - 클래스 간의 상속은 단일 상속만 가능(부모 클래스가 1개만 올 수 있다)
...
public class Notebook extends Product {  /* extends Object (+ import까지 하기) */
...
//		this.brand = brand;(this는 본인 클래스내에서만 사용가능)
		// 부모 멤버변수 초기화를 할 수 있는 방법
	...
	// 1. super. 을 통해서 부모의 멤버변수에 직접 접근
		...
		super.price = price; // 부모가 public - 어디서나 접근이 가능
		*/
	 ...
	 * */
		...
		this.setpCode(pCode);  // 부모의 public에 this로 접근 가능
		setName(name);
		setPrice(price);
		*/
