...
public class C_Arithmetic {
	...
	public void method1() {
		...
		System.out.println("num1 / num2 = " + (num1 / num2)); // 나누기했을 때의 몫 : 3
		System.out.println("num1 % num2 = " + (num1 % num2)); // 나누기했을 때의 나머지 : 1
		...
		public void method2() {
			...
			int f = e++; // a=6, b=10, c=16, d=2, e=4(계산후:5), f=4
			int g = (--b) + (d--); // b=9, d=2(계산후:1), g=11
			int h = 2;
