 ...
 * - applyXXX() 추상 메서드는 주로 매개값을 이용해서 연산하고 동일한 타입으로 결과를 리턴하는 역할을 함
 * */
...
//		d.method2();
	...
	public void method1() {
		...
		System.out.println(ibo.applyAsInt(10, 20));  // 출력 : 30 
	}
	...
	public void method2() {
		...
		System.out.println(ino.applyAsInt(10));  // 출력 : 100
	}
	
	
	// BinaryOperator<T> : T와 T를 연산한 후 T를 리턴 
	public void method3() {
		BinaryOperator<Student> bo = (student1, student2) 
				-> student1.getMath() > student2.getMath() ? student1 : student2;    // 삼항연산자
