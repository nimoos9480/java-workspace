...
/*
 * Predicate
 * - Predicate 함수적 인터페이스는 매개변수와 boolean 값을 리턴하는 testXXX() 추상 메서드를 가지고 있음
 * - testXXX() 추상 메서드는 매개값을 조사해서 true/false를 리턴하는 역할을 함
 * */
...
//		e.method2(student1, student2);
	...
	// BiPredicate<T ,U> :  객체 T와 U를 비교 조사함
	...
	public void method3() {
		...
		System.out.println(ip.test(90)); // 90이 100보다 크냐? 출력 : false
		System.out.println(ip.test(101)); // 출력 : true
	}
