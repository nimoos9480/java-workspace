...
//		c.method2();
	...
	// mapXXX() : 요소를 대체하는 요소로 구성된 새로운 스트림을 생성함
	public void method1() {
...
//										// student 이름을 가져온다
		...
		students.stream().map(Student::getName).forEach(System.out::println); 				//  같은 코드		
		
		System.out.println();
		
		// 수학 점수의 평균
		double avg = students.stream().mapToInt(student -> student.getMath()).average().getAsDouble();
																								// 학생들의 수학점수의 평균			// 더블로 변경
	...
	// flatMapXXX() : 하나의 요소를 복수의 요소들로 구성된 새로운 스트림을 생성함
	public void method2() {
	...
	// asDoubleStream() : IntStream, LongStream을 DoubleStream으로 변환함
	public void method3() {
