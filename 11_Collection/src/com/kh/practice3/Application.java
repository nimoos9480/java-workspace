	...
	public void mainMenu() {
		...
		try {
			while (check) {
				...
				default : 
					throw new Exception(); // 나머지 숫자 올 때 예외처리로 던져버리기
				}
			}

		} catch (Exception e) {
			System.out.println("잘못 입력하셨습니다. 다시 입력해주세요.");
			mainMenu();  // 자기자신 호출해서 되돌아감 
		}
	}
...
//				throw new Error();로 해도 가능
	...
	public void buyFarm() {
		 ...
		 * */
			...
			try {
				...
				if (result) { // 위의 스위치를 겪고 내려오는 result 값
	...
	public void printBuyFarm() {
		...
		// fc의 printBuyFarm()의 반환 값을 이용하여 출력  // 반환값 list
