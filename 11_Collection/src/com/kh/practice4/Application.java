...
public class Application {
	...
	public void joinMembership() {
		 ...
		 * */
			...
			if(mc.joinMembership(id, new Member(password, name))) {  // 반환타입이 boolean인 경우 조건식으로 바로 쓰면 됨!
	...
	public void login() {
		...
		String name = mc.login(id, password);  // login 반환타입 String
	...
	public void changePassword() {
		...
		if(mc.changePassword(id, oldPw, newPw)) {  // 반환타입 boolean이니까 바로 조건식에 넣기
