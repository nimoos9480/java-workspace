...
public class Application {
	...
	public void removeMusic() {
		...
		Music m = mc.removeMusic(sc.nextLine());  // 입력값 그대로 넣기
		if(m != null) {
	...
	public void setMusic() {
		...
		m.setArtist(sc.nextLine());
		
		Music result = mc.setMusic(title, m); // 반환값이 Music
